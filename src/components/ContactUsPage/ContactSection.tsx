...
import contactSideImage from '../../assets/images/banner3.svg';
...
const ContactSection: React.FC = () => {
  ...
  return (
    <div className="bg-white pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl xl:max-w-5xl w-full space-y-8 md:space-y-0 md:flex md:space-x-24 items-stretch">
        {/* Left Column: Image */}
        <div className="hidden md:flex md:w-7/12 w-full items-center">
          <img
        ...
        {/* Right Column: Form */}
        <div className="md:w-5/12 w-full flex flex-col p-4 md:p-0 md:pt-24">
